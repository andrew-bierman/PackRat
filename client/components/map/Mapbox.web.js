...
// attempting to resolve font issue
...
export function Mapbox() {
    ...
    const loadFonts = async () => {
        await Font.loadAsync({
          ...
          'OpenSans-Bold': {
            uri: 'https://fonts.googleapis.com/css2?family=Open+Sans:wght@700&display=swap',
            fontDisplay: 'swap',
          },
        });
      };
    ...
    //     const loadMap = async () => {
    //       if (Platform.OS === 'web') {
    //         // Load the Mapbox CSS file as a string
    //         const cssString = await Asset.fromModule(require('../../assets/mapbox/mapbox-gl.css')).downloadAsync();

    //         // Inject the CSS string into the DOM using a style element
    ...
    link.href = 'https://fonts.googleapis.com/css?family=Open+Sans:400&display=swap';
    link.rel = 'preload';
    link.as = 'font';
