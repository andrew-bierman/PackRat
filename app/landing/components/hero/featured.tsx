import expoIcon from '@/app/landing/assets/expo-logos/png/logo.png'
            ...
            <div className=" bg-opacity-50 py-4">
                <div className="container mx-auto text-center">
                    ...
                    <div className="flex justify-center space-x-4">
                        <div className="bg-secondary bg-opacity-20 p-2 rounded-full w-10 h-10 flex items-center justify-center" title='React-Native'>
                        ...
                        <div className="bg-secondary bg-opacity-20 p-2 rounded-full w-10 h-10 flex items-center justify-center">
                            <Image src={expoIcon} alt="expo icon" className='object-contain' title='expo' />
                        </div>
                        <div className="bg-secondary bg-opacity-20 p-2 rounded-full w-10 h-10 flex items-center justify-center">
                            <img src="https://avatars.githubusercontent.com/u/94025540?s=200&v=4" alt="tamagui icon" className='object-contain' title='tamagui' />
                        </div>
                        <div className="bg-secondary bg-opacity-20 p-2 rounded-full w-10 h-10 flex items-center justify-center">
                            <img src="https://nodejs.org/static/images/logo.svg" alt="tamagui icon" className='object-contain' title='nodejs' />
                        </div>
                        <div className="bg-secondary bg-opacity-20 p-2 rounded-full w-10 h-10 flex items-center justify-center">
                            <img src="https://trpc.io/img/logo.svg" alt="trpc icon" className='object-contain' title='trpc' />
                        </div>
                    </div>
                </div>
            </div>
