...
const Navigation = () => {
  ...
  const [isMobileView, setIsMobileView] = useState(Dimensions.get('window').width < 1024)
  ...
  useEffect(() => {
    const handleScreenResize = () => {
      const isMobile = Dimensions.get('window').width < 1300 || (navBarWidth < 1024 && !firstRender) // Adjust these values as needed
