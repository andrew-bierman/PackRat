  ...
  return (
    <div className="flex flex-col items-center justify-center max-w-screen-lg  mx-auto my-24 ">
      <div className="relative">
        <div className="absolute -inset-2 rounded-full bg-[radial-gradient(ellipse_at_right,_var(--tw-gradient-stops))] from-blue-600 to-purple-300 opacity-10 blur-2xl"></div>
