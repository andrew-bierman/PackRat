    ...
    <div>
      <div className="px-8 py-12">
        <div className="flex flex-col items-center text-center">
          <div className="text-center py-2 px-4">
            <div className=" flex justify-center items-center border border-primary rounded-xl p-1 max-w-fit ">
              <svg
                ...
                viewBox="0 0 24 24"
                fill="currentColor"
                className="w-4 h-4 mr-1 ml-1 animate-pulse"
              >
                <path
                  fillRule="evenodd"
          ...
          <h1 className="mt-4 text-7xl font-bold max-w-lg mx-auto">
            {heroDescription.firstLine}
            <br />
            <span className=" bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-red-400">
              {heroDescription.secondLineWithGradient}
            </span>{' '}
            <br />
            <span className="">
              {heroDescription.thirdLine}
              <span className=" bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-purple-600">
                {' '}
                {heroDescription.thirdLineWithGradient}
              </span>
            </span>
          </h1>
