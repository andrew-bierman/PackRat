...
const tripActivityValues = Object.values(TripActivity);
...
// @ts-ignore
const coordinateSchema = z.lazy(() => z.union([z.number(), z.array(coordinateSchema)]));
...
const featurePropertiesSchema = z.record(z.union([z.string(), z.number(), z.boolean()]));
...
//# sourceMappingURL=tripRoutesValidator.js.map