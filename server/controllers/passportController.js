...
export const signInGoogle = async (req, res) => {
    ...
    if (existingUser) {
      ...
      return res.status(200).json({ message: 'User signed in successfully', user: existingUser, token: userToken });
    } else {
      ...
      return res.status(201).json({ message: 'User created successfully', user: newUser, token: userToken });
    }
};
