...
import { createInstanceFromCoordinates, coordinatesToInstances, handleGeometry, handleGeoJSONGeometry } from './coordinateHandlers.js';
import { isOSMFormat, isGeoJSONFormat, propertiesToTags, extractIdAndType } from './dataFormatters.js';
...
export async function fromOSM(Model, data) {
  ...
  export async function updateInstanceFromGeoJSON(instance, geoJSON) {
      ...
      instance.tags = propertiesToTags(geoJSON.properties);
      instance.nodes = await coordinatesToInstances(Node, handleGeoJSONGeometry(geoJSON.geometry));
      instance.geoJSON = geoJSON;
      return instance;
  }
