...
import {
	...
	__facade_invoke__,
	__facade_register__,
} from "/home/awais/PackRat/node_modules/wrangler/templates/middleware/common.ts";

import worker from "/home/awais/PackRat/server/src/.wrangler/tmp/bundle-QkSCc7/middleware-insertion-facade.js";

// We need to preserve all of the exports from the worker
export * from "/home/awais/PackRat/server/src/.wrangler/tmp/bundle-QkSCc7/middleware-insertion-facade.js";
