...
import {
  ...
  __facade_invoke__,
  __facade_register__,
} from '/Users/andrewbierman/.nvm/versions/node/v18.17.1/lib/node_modules/wrangler/templates/middleware/common.ts';

import worker from '/Users/andrewbierman/Dropbox/AppAcademy/PackRat/PackRat/server/src/.wrangler/tmp/bundle-SMkFQB/middleware-insertion-facade.js';

// We need to preserve all of the exports from the worker
export * from '/Users/andrewbierman/Dropbox/AppAcademy/PackRat/PackRat/server/src/.wrangler/tmp/bundle-SMkFQB/middleware-insertion-facade.js';
