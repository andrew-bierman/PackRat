...
export default defineConfig({
  ...
  resolve: { // Add the resolve configuration
    alias: {
      ...
      'react-native/Libraries/Image/AssetRegistry': resolve(__dirname, '../../node_modules/react-native-web/dist/modules/AssetRegistry'),
      '@react-native/assets-registry/regisery': resolve(__dirname, '../../node_modules/react-native-web/dist/modules/AssetRegistry'),
    },
  },
  optimizeDeps: {
    esbuildOptions: {
